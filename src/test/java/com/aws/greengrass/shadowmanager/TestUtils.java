...
public final class TestUtils {
    ...
    public static final String RESERVED_SHADOW_NAME = "$testReservedShadowName";
    ...
    public static final String INVALID_RESERVED_SHADOW_NAME = "invalidReservedShadowName$";
    ...
    static Stream<Arguments> invalidThingAndShadowName() {
        return Stream.of(
                ...
                arguments(THING_NAME, INVALID_RESERVED_SHADOW_NAME)
        );
    }
    ...
    static Stream<Arguments> invalidShadowNames() {
        return Stream.of(
                arguments(INVALID_NAME_PATTERN),
                arguments(INVALID_NAME_LENGTH),
                arguments(INVALID_RESERVED_SHADOW_NAME)
        );
    }
